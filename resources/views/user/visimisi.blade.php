            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Tentang</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="/visimisi" class="nav-link disabled active">Visi dan Misi</a></li>
        ...
        <section class="about" data-aos="fade-up">
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        <h4>Visi</h4>
                        <ul>
                            <li>Menyediakan layanan, menghimpun pustaka dan akses informasi bagi Sobat SKUY untuk
                                mendukung pelaksanaan
                                tridharma perguruan tinggi, dan tercapainya masyarakat Indonesia berbasis pengetahuan.
                            </li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        <h4>Misi</h4>
                        <li>Menunjang keberhasilan Misi SKUY dengan memberikan layanan informasi secara efektif dan
                            efisien.</li><br>
                        <li>Menjadi mitra profesional bagi para peneliti dan pendidik.</li><br>
                        <li>Mengembangkan, mengorganisasi, dan mendayagunakan koleksi ilmu pengetahuan, sains dan
                            teknologi serta humaniora sebagai bahan rujukan bagi sivitas akademika dan masyarakat
                            sehingga tercipta masyarakat produsen informasi.</li><br>
                        <li>Menyebarluaskan informasi, khususnya intellectual capital SKUY, agar dapat dimanfaatkan oleh
                            Sobat SKUY,
                            dan juga masyarakat di seluruh dunia dengan memanfaatkan teknologi informasi yang ada dan
                            yang akan ada.</li><br>
                        <li>Menjalin kerja sama dengan berbagai institusi di dalam dan luar negeri untuk memperoleh
                            informasi yang dibutuhkan oleh sivitas akademika dan masyarakat.</li>
                    </div>
                </div>
            </div>
