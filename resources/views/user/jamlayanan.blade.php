        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Tentang</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="/jamlayanan" class="nav-link disabled active">Jam Layanan</a></li>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h1><strong>Jam Layanan</strong></h1>
        </div>
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
        <div class="row">
          <div class="col-sm-9">
            <h4>Jam Layanan Perpustakaan SKUY</h4>

            <ol type="1">
              <p>
                Berikut informasi jam layanan perpustakaan Skuy
              </p>
              <ul>
                <li><i class="bi bi-dot"></i> Senin - Kamis Pukul 08.00-16.00 WIB</li>
                <li><i class="bi bi-dot"></i> Jum'at Pukul 08.00-11.00</li>
                <li><i class="bi bi-dot"></i> Jum'at Pukul 13.00-16.00 WIB</li>
              </ul>
            </ol>
          </div>
        </div>
