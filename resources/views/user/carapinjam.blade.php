...
<head>
  ...
  <title>Skuy | Peminjaman Buku</title>
...
<main id="main">
<section class="breadcrumbs pt">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h1><strong>Peminjmanan Buku</strong></h1>
            </div>
        </div>
    </section>
<!-- ======= About Section ======= -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 pt-4 pt-lg-0">
          <br></br><br></br>
          <h5 class="fst-italic">
            Tata cara peminjaman buku online
          </h5> 
          <br></br>
          <p>
          1. Silahkan klik link disamping : <a href="https://docs.google.com/forms/d/1J14dhodsJ5BHnm0KRp-bqJS-ANSSo7jncGEqahBopQE/viewform?edit_requested=true">Link Peminjaman</a>
          </p>
          <p>
          2. Carilah koleksi buku perpustakaan di Katalog Online Skuy Library.
          </p>
          <p>
          3. Masukkan nama Anda dan buku yang anda inginkan serta akan diambil atau dikirimkan. 
          </p>
          <p>
          4. Ketersedian buku akan dikonfirmasi lewat WA atau email, silahkan dicek. 
          </p>
          <p>
          5. Pengambilan buku akan diinfokan melalui whatsap/email apabila buku sudah siap. Batas waktu permintaan jam 12.00 pada hari itu agar dapat diambil besok harinya.
          </p>
          <p>
          6. Buku yang telah dipesan harus diambil maksimal  3 hari sesudah pemesanan.
          </p>
          <p>
          7. Waktu peminjaman selama 14 hari setelah transaksi peminjaman dan bagi yang terlambat dikenakan denda.
          </p>
          <p>
          8. Buku bisa diambil atau akan dikirimkan sehari sesudahnya (kecuali hari libur).
          </p>
          <p>
          9. Apabila ada permasalahan peminjaman maka data pribadi yang diupload dianggap sebagai pihak yang bertanggung jawab. 
          </p>
          <br></br>
          <h5 class="fst-italic">
            Tata cara peminjaman buku offline
          </h5>
          <br></br>
          <p>
          1. Pilihlah buku yang tersedia di Skuy Library.
          </p>
          <p>
            2. Bawa buku yang ingin anda pinjam kepada petugas perpustakaan.
          </p>
          <p>
          3. Berikan buku yang anda pinjam ke petugas perpustakaan. 
          </p>
          <p>
          4. Tunjukan Kartu Identitas Mahasiswa (KTM) pada petugas perpustakaan 
          </p>
          <p>
          5. Tunggulah proses pendataan petugas perpustakaan. 
          </p>
          <p>
          6. Selesai. 
          </p>    
