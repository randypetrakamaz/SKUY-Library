  ...
  <section id="portfolio-details" class="portfolio-details">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8">
          <img src="{{ asset ('storage/' . $data -> gambar) }}" class="img-fluid rounded mx-auto d-block" alt="">
        </div>
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            <h3>{{$data -> judul}}</h3>
            <ul>
              <li><strong>Jumlah</strong>: {{$data -> jumlah}}</li>
              <li><strong>Bahasa</strong>: {{$data -> bahasa}}</li>
              <li><strong>Terbit</strong>: {{$data -> terbit}}</li>
              <li><strong>Halaman</strong>: {{$data -> halaman}}</li>
              <li>
                <a class="btn btn-outline-info justify-content-between" href="/carapinjam" role="button">Peminjaman</a>
                &nbsp
                <a class="btn btn-outline-info justify-content-between" href="/kembali" role="button">Pengembalian</a>
