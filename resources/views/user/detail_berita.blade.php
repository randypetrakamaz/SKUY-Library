          ...
          <div class="col-lg-10 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry mb-5">
                <img src="{{ asset('storage/' . $beritas->image) }}" alt="" class="img-fluid">
              </div>
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-calendar"></i> <a href="blog-single.html"><time
                        datetime="2020-01-01">{{ $beritas->updated_at->format("d/m/Y") }}</time></a></li>
                </ul>
              </div>

              <div class="entry-content">{!! $beritas->body !!}</div>

              <div class="entry-footer mt-4"></div>
            </article>
