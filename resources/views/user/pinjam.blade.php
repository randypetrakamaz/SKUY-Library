...
<head>
  ...
  <title>Skuy | Peminjamaman Buku</title>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="/cari"><span>Layanan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a class="active nav-link disabled" href="/pinjam">Peminjaman Buku</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Cari Buku</h3>
            <p class="fst-italic">
              Silahkan cari buku yang tersedia di perpustakaan kami
            </p>
          ...
          <div class="col-lg-12 pt-4 pt-lg-0">
            ...
            if(str_contains(strtolower($si -> judul), strtolower($search)) == 1) {?>

            <div class="col-md-auto d-flex align-items-stretch" data-aos="fade-up">
              <img src="{{ asset ('storage/' . $si -> gambar) }}" class="img-fluid" style="width: auto; height: 300px;"
                alt="">
              <div class="card">

                <div class="card-body">
                  <h5 class="card-title"><a href="{{route('buku.show',$si->id)}}">
                      {{$si -> judul}}
                    </a></h5>
                  <p class="card-text" align="justify">{{$si -> sinopsis1}}</p>
                  <div class="read-more"><a href="{{route('buku.show',$si->id)}}"><i class="bi bi-arrow-right"></i> Read
                      More</a></div>
                </div>
